...
// the following are set as the default
    ...
    public int[] CompID = {1,2,3};//{1, 2, 3};
    public int[] HsampFactor = {1,1,1};//{2,1,1,2,2,2}; //{1,1,1}{1, 2, 2};
    public int[] VsampFactor = {1,1,1};//{2,1,1,2,2,2};//{1,1,1}{1, 2, 2};
    public int[] QtableNumber = {0, 1, 1};//{0,0,0,0,1,1};//
    public int[] DCtableNumber = {0, 1, 1};//{0,0,0,0,1,1};
    public int[] ACtableNumber = {0, 1, 1};//{0,0,0,0,1,1};
    public boolean[] lastColumnIsDummy = {false,false,false};//{false, false, false};
    public boolean[] lastRowIsDummy = {false, false, false};//{false, false, false};
    public int Ss = 0;
    public int Se = 63;
    public int Ah = 0;
    public int Al = 0;
