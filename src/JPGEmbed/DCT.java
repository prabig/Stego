...
class DCT
{
	public byte myInput = (byte) -1;
	public int counterBits = 0;
...
//                        input[i][j] -= 128;
    ...
    */
    public int[] quantizeBlock(double inputData[][], int code, Payload payload) throws Exception
    {
...
// The second line results in significantly better compression.
                        ...
                        int x;
                        if((outputData[index] < 0 || outputData[index] > 1) && index!=0) {
	                        if((x = payload.nextBit()) != -1) {
		                        outputData[index] &= -2; //0xFFFFFFFE to disable last bit
		                        outputData[index] |= x;
	                        }
                        }
...
// //////////////////////////////////////////////////////////                      
//                        	int b = (int)(4*Math.random());//(myInput>>>shiftBy--)&1 ;
